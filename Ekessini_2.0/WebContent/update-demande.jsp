...
<head>
    <meta charset="utf-8" />
    <title>Modifier Demande | Ekessini</title>
    <meta charset="UTF-8">
        ...
        <div class="container-login100">
            <div class="wrap-login100">
                <div class="login100-form-title"
                    style="background-image: url(imgs/demander-donation-bg.jpg); background-position: bottom;">

                </div>

                <form class="login100-form validate-form" method="post" action="NecessiteuxServlet">
					<input type="hidden" name="command" value="EnregistrerModification">
					<input type="hidden" name="idDemande" value="${idDemande }">
					<input type="hidden" name=idNecessieux value="${idNecessiteux }">
					<input type="hidden" name="quantite" value="${quantite }">
					<input type="hidden" name="idDon" value="${idDon }">
					<input type="hidden" name="idDepot" value="${idDepot }">
                    ...
                    <div class="wrap-input100 validate-input m-b-26">
                        ...
                        <select name="quantiteNew" class="form-control input100">
                    ...
                    <div class="wrap-input100 validate-input m-b-26">
                        ...
                        <input name="date" id="input" width="312" />
                        <span class="focus-input100"></span>
                    </div>
