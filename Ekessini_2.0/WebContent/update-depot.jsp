...
<head>
    <title>Modifier Depot | Ekessini</title>
    <meta charset="UTF-8">
...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link js-scroll-trigger" href="#aider">Logout</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="row">
      ...
      <div class="col-md-3">
        ...
        <select id="chambre" name="chambre" class="form-control">
          ...
          <option value="pantalon">Pantlon</option>
    ...
    <div class="form-container">
        ...
        <input type="hidden" name="command" value="saveUpdateDepot">
    	<input type="hidden" name="role" value="${role }">
    	<input type="hidden" name="idDepot" value="${idDepot }">
            <fieldset>
                <!-- Form Name -->
                <legend class="title">Modifier Depot ${localisation }</legend>
                ...
                <div class="form-group text-center">
                    <div class="row">
                        <div class="col-md-12">
                            <p class="add-one d-inline">+ Chambre</p>
                        </div>
