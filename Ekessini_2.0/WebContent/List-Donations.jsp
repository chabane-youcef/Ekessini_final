...
<head>
    <title>List Donations | Ekessini</title>
    <meta charset="UTF-8">
            ...
            <div class="row m-3">
                ...
                <div class="table-responsive text-nowrap mt-5">
                    <table class="table table-striped">
                        ...
                        <tbody>
	                        <c:forEach items="${ donations}" var="tempD">
	                            <tr>
	                                ...
	                                <!-- Valider Link -->
	                                <c:url var="ValiderDonationLink" value="GestionnaireServlet">
	                        			<c:param name="command" value="validerDonation"/>
	                        			...
	                        			<c:set scope="request" value="${tempD.period }" var="Period"/>
	                        			<c:param name="period" value="${ Period}" />
	                        			
	                        			<c:set scope="request" value="${tempD.type }" var="Type"/>
	                        			<c:param name="type" value="${ Type}" />
	                        			
	                        			<c:set scope="request" value="${tempD.genre }" var="Genre"/>
	                        			<c:param name="genre" value="${ Genre}" />
	                        		</c:url>
	                        		
	                        		<!-- rfuser Link -->
	                        		<c:url var="RefuserDonationLink" value="GestionnaireServlet">
	                        			<c:param name="command" value="RefuserDonation"/>
	                                ...
	                                <th><a href="${ValiderDonationLink }" class="btn btn-outline-success">Valider</a></th>
                                	<th><a href="${RefuserDonationLink }" class="btn btn-outline-danger">Refuser</a></th>
	                            </tr>
							</c:forEach>
                        </tbody>
                    </table>
