...
<head>
    <meta charset="utf-8" />
    <title>Ajoute Donation | Ekessini</title>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item">
                        <a class="nav-link js-scroll-trigger" href="Donateur-profil.jsp">Home</a>
                    </li>
        ...
        <div class="container-login100">
            <div class="wrap-login100">
                ...
                <form class="login100-form validate-form" method="post" action="DonateurServlet">
					<input type="hidden" name="command" value="ajoutAutreDonation">
					<input type="hidden" name="idDonateur" value="${idDonateur }">
