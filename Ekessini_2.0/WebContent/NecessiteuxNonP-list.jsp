...
<head>
    ...
    <title>Necessiteux Non Permanent | Ekessini</title>
                ...
                <table class="table">
                    <thead>
                        <tr>
                            ...
                            <th scope="col" class="text-center">Voir Profil</th>

                        </tr>
                    </thead>
                    <tbody>
                    	
						<c:forEach items="${ NecNonPerList}" var="tempN">
                    	
	                        <tr>  
	                        	<c:url var="NecessiteuxProfilLink" value="AdminServlet">
	                        		<c:param name="command" value="NecessiteuxProfil"/>
	                        		<c:set scope="request" value="${tempN.idNecessiteux }" var="IdNec"/>
	                            ...
	                            <td class="text-center">
	                            	<a href="${NecessiteuxProfilLink }" class="btn btn-sm btn-info">Profil</a>
	                            </td>
	                        </tr>
